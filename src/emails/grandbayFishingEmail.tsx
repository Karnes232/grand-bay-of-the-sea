...
export const grandbayFishingEmail = ({
        ...
        <Tailwind>
          <Container className="bg-white max-w-2xl mx-auto my-8 rounded-lg shadow-lg">
            ...
            <Section className="bg-gray-50 mx-8 p-6 rounded-lg">
              ...
              <Text className="text-gray-700">
                <strong>Number of Fishermen:</strong> {guestCount}
              </Text>

              <Text className="text-gray-700">
                <strong>Number of Spectators:</strong> {spectator}
              </Text>
...
export default grandbayFishingEmail

...
export async function generateMetadata(): Promise<Metadata> {
  const pageSeo = await getIndividualCourseSEO("discover")
  ...
  if (!pageSeo) {
    ...
    throw new Error(
      "[metadata] SEO data came back empty for /tui/discover. " +
        "Check the Sanity individualCourse 'discover' seo fields.",
    )
  }
...
export default async function Page() {
  const course = await getIndividualCourse("discover")
  return (
    <main id="main">
      <BackgroundVideo

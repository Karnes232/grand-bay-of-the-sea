...
import TuiOpenWaterOverview from "@/components/TuiComponents/TuiOpenWaterOverview"
import {
  getIndividualCourse,
...
export async function generateMetadata(): Promise<Metadata> {
  const pageSeo = await getIndividualCourseSEO("openwater")
  ...
  if (!pageSeo) {
    ...
    throw new Error(
      "[metadata] SEO data came back empty for /tui/openwater. " +
        "Check the Sanity individualCourse 'openwater' seo fields.",
    )
  }
  ...
  return {
    ...
    openGraph: {
      url: `https://www.grandbay-puntacana.com/tui/openwater`,
      type: "website",
    ...
    alternates: {
      canonical: `https://www.grandbay-puntacana.com/tui/openwater/`,
    },
  }
}

export default async function Page() {
  const course = await getIndividualCourse("openwater")
  return (
    <main id="main">
      <BackgroundVideo

...
export async function generateMetadata(): Promise<Metadata> {
  const pageSeo = await getTripSeo("bayahibe")
  ...
  if (!pageSeo) {
    ...
    throw new Error(
      "[metadata] SEO data came back empty for /tui/bayahibe. " +
        "Check the Sanity trips 'bayahibe' seo fields.",
    )
  }
...
export default async function Page() {
  const tour = await getIndividualTrip("bayahibe")

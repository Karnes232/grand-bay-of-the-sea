...
export async function generateMetadata(): Promise<Metadata> {
  const pageSeo = await getIndividualCourseSEO("scubadiver")
  ...
  if (!pageSeo) {
    ...
    throw new Error(
      "[metadata] SEO data came back empty for /tui/scubadiver. " +
        "Check the Sanity individualCourse 'scubadiver' seo fields.",
    )
  }
...
export default async function Page() {
  const course = await getIndividualCourse("scubadiver")
  return (
    <main id="main">
      <BackgroundVideo
